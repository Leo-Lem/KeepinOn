...
enum Strings: LocalizedStringKey, Localizable {
    ...
    static let deleteProjAlert: (title: LocalizedStringKey, message: LocalizedStringKey) = ("PROJECT_DELETE_ALERT_TITLE", "PROJECT_DELETE_ALERT_MESSAGE")
    
    case itemNamePlaceholder = "ITEM_NAME",
         itemDescPlaceholder  = "ITEM_DESCRIPTION",
         markItemCompleted = "MARK_COMPLETED",
         priority = "PRIORITY"
    static let priorities: (low: LocalizedStringKey, mid: LocalizedStringKey, high: LocalizedStringKey) = ("PRIORITY_LOW", "PRIORITY_MID", "PRIORITY_HIGH")
    
    static func a11yDescription(project: String, items: Int, progress: Double) -> LocalizedStringKey { "A11Y_COMPLETE_DESCRIPTION \(project) \(items) \(progress)" }
